...
export default function About() {
  const organizationJsonLd = {
    ...
    description:
      'Dev Brains AI builds 30 free browser-based developer tools — regex, SQL, JSON, cron, JWT, hashing, and encoding utilities — plus 150+ in-depth guides.',
  };
  ...
  const aboutPageJsonLd = {
    ...
    description:
      'Dev Brains AI is a free toolkit of 30 browser-based developer utilities and 150+ guides covering regex, SQL, JSON, cron, JWT, and encoding.',
    publisher: {
      '@id': 'https://dev-brains-ai.com/#organization',
    },
  };
      ...
      <main className="container" style={{ paddingTop: 22 }}>
        ...
        >
          ...
          <p className="small" style={{ marginBottom: 16 }}>
            <strong>Dev Brains AI</strong> is a free toolkit of 30 browser-based utilities for
