...
export default function About() {
  ...
  const aboutPageJsonLd = {
    ...
    description:
      'Dev Brains AI is a free toolkit of 29 browser-based developer utilities and 150+ guides covering regex, SQL, JSON, cron, JWT, and encoding.',
    publisher: {
      '@id': 'https://dev-brains-ai.com/#organization',
    },
  };
      ...
      <main className="container" style={{ paddingTop: 22 }}>
        ...
        >
          ...
          <p className="small" style={{ marginBottom: 16 }}>
            <strong>Dev Brains AI</strong> is a free toolkit of 29 browser-based utilities for
