  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Copy-paste UUID recipes: crypto.randomUUID() in JS, Python uuid4/uuid5, MySQL UUID_TO_BIN, PostgreSQL gen_random_uuid(), and efficient BINARY(16) storage."
        />
        <meta
          name="keywords"
