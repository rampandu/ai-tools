...
const POST_META = {
  ...
  "sql-query-visualizer-guide-how-it-works": { title: "SQL Query Visualizer Guide: How to Read the Diagram", description: "A worked example showing how the SQL Query Visualizer turns a 3-table query into a join diagram and execution-order list, plus what an unlabeled join edge warns you about." },
