...
const POST_META = {
  ...
  "sql-join-interview-questions-with-examples": { title: "SQL JOIN Interview Questions: INNER, LEFT, RIGHT, FULL", description: "Practice real INNER JOIN, LEFT JOIN, RIGHT JOIN, and FULL JOIN interview questions with sample tables and queries asked at TCS, Infosys, Wipro, and Accenture." },
  ...
  "sql-queries-asked-in-accenture-capgemini-interviews": { title: "SQL Interview Questions Asked at Accenture & Capgemini", description: "Real SQL questions from Accenture and Capgemini interviews: WHERE vs HAVING, the Nth highest salary query with DENSE_RANK, and practical date-filtering examples." },
  ...
  "top-sql-interview-questions-tcs-infosys-wipro": { title: "SQL Interview Questions for TCS, Infosys & Wipro", description: "SQL interview prep for TCS, Infosys, and Wipro: the exact DELETE vs TRUNCATE vs DROP, second-highest-salary, and JOIN questions asked, with worked answers." },
  ...
  "regex-for-pan-card-validation": { title: "PAN Card Regex Validation: JavaScript & Python Examples", description: "Validate Indian PAN card numbers with one 10-character regex — copy-paste JavaScript and Python code, format breakdown, and the mistakes that break it." },
  ...
  "fix-invalid-json-error-in-nodejs": { title: "Fix \"Unexpected Token in JSON\" Errors in Node.js", description: "See what triggers \"SyntaxError: Unexpected token in JSON\" in Node.js — 3 real causes (trailing commas, single quotes, empty input) and the try/catch fix." },
  ...
  "ai-projects-for-engineering-students-india": { title: "20+ AI Project Ideas for Engineering Students in India", description: "20+ AI project ideas for Indian engineering students, from spam classifiers to crop disease detection, plus a working Python code example to get started." },
  "best-ai-projects-for-final-year-btech": { title: "20 AI Projects for Final Year B.Tech Students in India", description: "20 AI project ideas for B.Tech finals — beginner to advanced, real Python code, FastAPI deployment, and India-specific problems like crop disease detection." },
  ...
  "regex-for-indian-passport-number-validation": { title: "Regex for Indian Passport Numbers (1 Letter + 7 Digits)", description: "A regex pattern for validating Indian passport numbers — one uppercase letter followed by seven digits — with JavaScript examples and real KYC-form edge cases." },
  "regex-for-driving-license-number-validation-india": { title: "Regex for Indian Driving License Numbers (State + RTO + Year)", description: "A regex pattern for validating Indian driving license numbers — 2-letter state code, RTO code, year, and 7-digit serial — plus why the format varies by state." },
  ...
  "sql-interview-questions-for-freshers-with-answers": { title: "SQL Interview Questions for Freshers, Fully Explained", description: "A fresher-level SQL interview cheat sheet: SELECT vs HAVING, all four JOIN types, primary vs foreign keys, 1NF-3NF, and DELETE vs TRUNCATE vs DROP." },
